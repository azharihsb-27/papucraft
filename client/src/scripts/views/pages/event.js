			...
			<div class="content">
				<article id="new-event" class="p-7 lg:p-14">
					...
					<div class="py-2 lg:py-9 flex flex-col gap-4">
						<img src="/img/bg.jpg" alt="Newest Event Image" class="w-full h-[490px] object-cover" id="new-thumbnail"/>
