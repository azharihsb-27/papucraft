        ...
        if(!success){
            ...
            <article class="mx-auto mt-5 mb-2 flex flex-col w-[90%] h-full">
                <div class="flex flex-col gap-2 h-[20%]">
                    <img src="${data.thumbnail}" class="md:max-h-[10%] rounded-lg" id="">
                    <div class="flex mt-2 gap-2 items-center">
                        <h3 class="font-bold">${data.source ? "Internet" : data.username}</h3> - <p class="text-sm">23/12/2021</p>
                        <a class="ml-auto flex items-center gap-1 text-sm hover:text-blue-500 cursor-pointer" href="${data.source}">
