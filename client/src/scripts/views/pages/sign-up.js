      ...
      <div class="md:w-1/2 h-screen flex my-auto justify-center relative flex-col px-5 py-[2rem] gap-2 h-screen">
        ...
        <div class="w-full flex flex-col h-[screen] justify-center backdrop-blur-md rounded-md">
          ...
          <form class="flex flex-col gap-2 px-4 py-[1rem] ">
            ...
            <button class="w-1/2 md:w-1/4 mx-auto font-bold rounded-md py-2 mt-4 bg-primary hover:border hover:border-2 hover:border-primary hover:text-primary hover:bg-transparent transition text-white" id="sign-up">Sign In</button>
